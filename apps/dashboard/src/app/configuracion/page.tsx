    ...
    <div className="flex min-h-screen bg-[#E0F2FE] font-sans text-slate-900 overflow-hidden">
      ...
      <aside className="w-72 bg-white border-r border-blue-100 p-8 flex flex-col gap-10 shadow-sm z-10">
        ...
        <nav className="flex flex-col gap-2">
          ...
          <a href="/configuracion" className="flex items-center justify-between p-4 bg-sky-500 text-white rounded-[1.5rem] font-bold shadow-xl shadow-sky-500/20 transition-all group">
            <div className="flex items-center gap-3">
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="h-24 border-b border-blue-100 bg-white/50 backdrop-blur-md px-12 flex items-center justify-between shrink-0">
          <div>
            <h1 className="text-2xl font-black tracking-tight">Configuración del Portal</h1>
            <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Parametrización General</p>
          </div>
