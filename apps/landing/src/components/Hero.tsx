    ...
    return (
        <section id="servicios" className="relative pt-44 pb-32 px-6 overflow-hidden">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full -z-10">
                ...
                <div className="absolute top-[10%] right-[-10%] w-[40%] h-[40%] bg-rRocita-red/5 blur-[100px] rounded-full"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col items-center text-center mb-24">
                    <motion.div
                        ...
                        <span className="w-2 h-2 bg-rRocita-red rounded-full animate-pulse"></span>
                    ...
                    <motion.h1
                        ...
                        Soy <span className="font-extrabold tracking-tight text-slate-900">Ro</span>
                        <span className="font-extrabold tracking-tight text-sky-500">cita</span>,<br />
                    ...
                    <motion.p
                        ...
                        La IA que transforma la inasistencia en rentabilidad. Notificaciones inteligentes, recordatorios
                        oportunos y confirmación automática.
                    </motion.p>
                    ...
                    <motion.div
                        ...
                        <button className="bg-white border-2 border-zinc-100 px-10 py-5 rounded-2xl text-xl font-bold hover:bg-zinc-50 transition-all text-zinc-700 flex items-center gap-2">
                            Cómo funciona <MousePointer2 size={18} className="text-rRocita-red" />
                        </button>
                    </motion.div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
                    {[
                        ...
                        },
                        {
                            ...
                            desc: (
                                <>
                                    ...
                                    <span className="font-extrabold tracking-tight text-sky-500">cita</span> procesa y
                        ...
                        },
                        {
                            step: "03",
                            title: "Agenda Llena",
                            desc: "Confirmaciones en tiempo real para tu equipo.",
                        ...
                        <motion.div
                            ...
                            <div
                                className={`${item.color} text-5xl font-black mb-6 opacity-20 group-hover:opacity-100 transition-opacity`}>
                                {item.step}
                            </div>
